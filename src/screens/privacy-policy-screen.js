...
function PrivacyPolicyScreen({ location }) {
  ...
  return <Container className={classes.container}>
    ...
    <Typography variant="body1" id="deletion-facebook">4.4. Пользователь в соответствии со стандартами Общего регламента по защите данных(GDPR) вправе воспользоваться правом на удаление предоставленной информации со стороннего сайта социальной сети <Link href={"https://www.facebook.com"} target="_blank" rel="noreferrer">Facebook</Link>.</Typography>
    <Box mx={1} my={1}>
      <Typography variant="body1">4.4.1. Перейти во вкладку с приложениями <Link href="https://www.facebook.com/settings?tab=applications" target="_blank" rel="noreferrer">Facebook profile&apos;s Apps and Websites</Link></Typography>
      <Typography variant="body1">4.4.2. Выбрать приложение {process.env.APP_NAME} и нажать на кнопку &quot;Remove&quot;</Typography>
      <Typography variant="body1">4.4.3. В открывшемся окне выбрать &quot;Send Request to trigger your callback.&quot;</Typography>
      <Typography variant="body1">4.4.4. Нажать на кнопку &quot;Remove&quot;</Typography>
    </Box>
    <Typography variant="h2" className={classes.h2Size}>
